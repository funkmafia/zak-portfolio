...
export default function Navbar() {
    return (
        <nav className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center" aria-label="Main Navigation">
    ...
    <ul id="navLinks" className="flex flex-col md:flex-row gap-6 justify-center transition-all duration-500 overflow-hidden max-h-0 md:max-h-full md:flex">
